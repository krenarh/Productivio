...
//Logic for login to store pass/user
document.addEventListener('DOMContentLoaded', function () {
...
//test credentials
var testCredentials = [
    { username: 'Kenz', password: 'password123', firstName: 'Krenar', lastName: 'Hazari' },
...
let reminderList = document.getElementById('reminderList');
//Add Menu reminder to show main div when the button from menu is clicked
...
//Productivio from the menu to show task bar and the timer
...
let all_songs = [
    {
        ...
        path: "./music/Hyakke - Kagefumi.mp3",
        img: "./images/a3145441046_5.jpg"
    },
    {
        name: "Nujabes - Aruarian dance",
        path: "./music/Nujabes - Aruarian dance.mp3",
        img: "./images/artworks-000010633044-0pecn0-t500x500.jpg"
    },
    {
        name: "Peacock Affect - Who Cares If You Exist (eisu remix)",
        path: "./music/Peacock Affect - Who Cares If You Exist (eisu remix).mp3",
        img: "./images/artworks-000092286828-3ghmnl-t240x240.jpg"
    },
    {
        name: "KOAN Sound - Lost In Thought",
        path: "./music/KOAN Sound - Lost In Thought.mp3",
        img: "./images/artworks-dblZ961xJv8n-0-t500x500.jpg"
    }
];
//fncs
// fnc load track
